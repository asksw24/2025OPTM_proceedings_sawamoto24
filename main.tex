...
To track pollution sources and environmental behavior, identifying the specific material type (e.g., polyethylene (PE) from packaging or polyethylene terephthalate (PET) from bottles) for every single sample collected in field surveys is essential~\cite{Hidalgo-Ruz2012}.
