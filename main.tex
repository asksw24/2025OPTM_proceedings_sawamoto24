...
Furthermore, our research group has extended this approach to fluorescence imaging to visualize the spatial distribution of quality attributes. Specifically, we successfully visualized the distribution of freshness indices (such as K-value and IMP content) in frozen fish fillets~\cite{Bui2018-hw} and achieved non-destructive prediction of pH in frozen fish meat~\cite{Rahman2022-zd}.
...
As a preliminary experiment, we measured the EEMs of the nine target polymers used in this study (HDPE, LDPE, PP, PS, PVC, PC, PMMA, PET, and ABS) using a fluorescence spectrophotometer (F-7000, Hitachi High-Technologies Corporation).
