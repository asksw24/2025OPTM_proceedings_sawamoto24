...
Fig~\ref{fig:eem} showed the measured EEMs.
...
\begin{itemize}
    ...
    HDPE and PET showed a clear peak around $k=3$ to $5$. Notably, for these materials, the F1-scores of the selected subset were higher than the full-spectrum baseline.
...
In contrast, mutual confusion was observed between PET and HDPE.
