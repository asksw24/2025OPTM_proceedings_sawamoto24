...
First, some confusion was observed between PET and HDPE (PET misclassification rate: approx. 35\%).
Although their EEM spectral shapes are originally different, the reduction of spectral bands to prioritize data acquisition efficiency caused their feature values to become close in the selected feature space (feature overlap).

Therefore, the root cause of the misclassification is attributable to the significant feature overlap between these classes in the reduced 8-dimensional space.
...
Since this study focuses on throughput improvement, strict particle-to-particle comparison with conventional methods was not performed.

Third, this experiment was conducted using virgin pellets.
