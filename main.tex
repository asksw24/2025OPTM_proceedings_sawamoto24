...
\begin{figure}[htbp]
  ...
  A distinct confusion is observed between HDPE and PET (True PET is misclassified as HDPE in 35\% of cases), highlighting the spectral similarity between these polymers.
...
The feature selection analysis, as shown in Fig~\ref{fig:optimization}(b), revealed that the top 5 spectral bands were selected in more than 7 out of 10 cross-validation folds.
